...
df = pd.read_csv("E:\project4\project2\Reviews.csv")
print(df.columns)
print(df.shape)
...
ProductReviewSummary.to_csv("E:\project4\project2\ProductReviewSummary.csv")

dfProductReview

df3 = pd.read_csv("E:\project4\project2\ProductReviewSummary.csv")
...
dfReviews.to_csv("E:\project4\project2\dfReviews.csv")
